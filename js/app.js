alert(`welcome to budgetcaluculator`);
  ...
  return {
    ...
    addlistitem: function (obj, type) {
      ...
      if (type === "inc") {
        ...
        html =
          '<div class="item clearfix" id="inc-%id%"><div class="item__description">%description%</div><div class="right"><div class="item__value">%value%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';
      } else if (type === "exp") {
        element = DomStrings.expensecontainer;
        html =
          '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right"><div class="item__value">%value%</div><div class="item__percentage">30%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';
      }
    ...
    displayBudget: function (obj) {
      ...
      document.querySelector(DomStrings.distotal).textContent = formateNumber(
        obj.budget,
        type
      );
      document.querySelector(DomStrings.disincom).textContent = formateNumber(
        obj.totalInc,
        "inc"
      );
      document.querySelector(DomStrings.disexp).textContent = formateNumber(
        obj.totalexp,
        "exp"
      );
      if (obj.percentage > 0) {
    ...
    date: function () {
      ...
      document.querySelector(DomStrings.dismonth).textContent =
        months[month] + " " + year;
    },

    changetype: function () {
      var fields = document.querySelectorAll(
        DomStrings.uxsel + "," + DomStrings.uxdes + "," + DomStrings.uxval
      );
...
var Appctlr = (function () {
  ...
  var buttonPress = function () {
    ...
    if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
      ...
      newItem = budgetControler.additem(
        input.type,
        input.description,
        input.value
      );
